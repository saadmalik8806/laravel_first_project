   ...
   <div class="container">
      <div class="row">
         ...
         <div class="wow fadeInUp col-md-offset-1 col-md-10 col-sm-offset-1 col-sm-10" data-wow-delay="2.3s">
               ...
               <img src="{{asset('public/images/blog-img1.jpg')}}" class="img-responsive post-image" alt="Blog">
                 ...
                 <h3>Comments</h3>
                    <div class="media">
                        <div class="media-object pull-left">
                            <img src="{{asset('public/images/comment1.jpg')}}" class="img-responsive" alt="blog">
                       </div>
                    ...
                    <div class="media">
                        <div class="media-object pull-left">
                            <img src="{{asset('public/images/comment2.jpg')}}" class="img-responsive" alt="blog">
                       </div>
                      <div class="media-body">
                        <h4 class="media-heading">Jenne leon</h4>
