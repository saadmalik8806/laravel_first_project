      ...
      <div class="row">
         ...
         <div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="1s">
         	  <div class="blog-thumb">
         		   <a href="single-post.html"><img src="{{asset('public/images/blog-img1.jpg')}}" class="img-responsive" alt="Blog"></a>
		    ...
		    <div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="1.6s">
         	  <div class="blog-thumb">
         		   <a href="single-post.html"><img src="{{asset('public/images/blog-img2.jpg')}}" class="img-responsive" alt="Blog"></a>
         		   <a href="single-post.html"><h1>Walk in the Moon</h1></a>
         			    <div class="post-format">
		    ...
		    <div class="wow fadeInUp col-md-4 col-sm-4" data-wow-delay="1.9s">
         	  <div class="blog-thumb">
         		   <a href="single-post.html"><img src="{{asset('public/images/blog-img3.jpg')}}" class="img-responsive" alt="Blog"></a>
         		   <a href="single-post.html"><h1>Swim the Pool</h1></a>
         			    <div class="post-format">
        ...
        <div class="wow fadeInUp col-md-4 col-sm-4" data-wow-delay="2.2s">
            <div class="blog-thumb">
               <a href="single-post.html"><img src="{{asset('publice/images/blog-img4.jpg')}}" class="img-responsive" alt="Blog"></a>
               <a href="single-post.html"><h1>Talking the Sun</h1></a>
                  <div class="post-format">
        ...
        <div class="wow fadeInUp col-md-4 col-sm-4" data-wow-delay="2s">
            <div class="blog-thumb">
               <a href="single-post.html"><img src="{{asset('public/images/blog-img5.jpg')}}" class="img-responsive" alt="Blog"></a>
               <a href="single-post.html"><h1>View the Mountain</h1></a>
                  <div class="post-format">
        ...
        <div class="wow fadeInUp col-md-3 col-sm-3" data-wow-delay="2.4s">
            <div class="blog-thumb">
               <a href="single-post.html"><img src="{{asset('public/images/blog-img6.jpg')}}" class="img-responsive" alt="Blog"></a>
               <a href="single-post.html"><h1>Mountain</h1></a>
                  <div class="post-format">
        ...
        <div class="wow fadeInUp col-md-3 col-sm-3" data-wow-delay="1.5s">
            <div class="blog-thumb">
               <a href="single-post.html"><img src="{{asset('public/images/blog-img7.jpg')}}" class="img-responsive" alt="Blog"></a>
               <a href="single-post.html"><h1>Cloud</h1></a>
                  <div class="post-format">
        ...
        <div class="wow fadeInUp col-md-3 col-sm-3" data-wow-delay="1s">
            <div class="blog-thumb">
               <a href="single-post.html"><img src="{{asset('public/images/blog-img8.jpg')}}" class="img-responsive" alt="Blog"></a>
               <a href="single-post.html"><h1>Blue Sky</h1></a>
                  <div class="post-format">
                    <span>By <a href="#">Elon Musk</a></span>
        ...
        <div class="wow fadeInUp col-md-3 col-sm-3" data-wow-delay="1.3s">
            <div class="blog-thumb">
               <a href="single-post.html"><img src="{{asset('pubic/images/blog-img9.jpg')}}" class="img-responsive" alt="Blog"></a>
               <a href="single-post.html"><h1>Forest</h1></a>
                  <div class="post-format">
                    <span>By <a href="#">Jack Ma</a></span>
...
<script src="{{asset('pubic/theme/js/custom.js')}}"></script>
